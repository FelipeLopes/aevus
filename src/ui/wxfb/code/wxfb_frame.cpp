...
WxfbFrame::WxfbFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	frameListCtrl = new wxDataViewListCtrl( m_scrolledWindow2, wxID_ANY, wxDefaultPosition, wxSize( -1,150 ), 0 );
	...
	m_dataViewListColumn14 = frameListCtrl->AppendTextColumn( wxT("Value"), wxDATAVIEW_CELL_EDITABLE, -2, static_cast<wxAlignment>(wxALIGN_CENTER_HORIZONTAL), wxDATAVIEW_COL_RESIZABLE );
	...
	trianglePanel->Connect( wxEVT_LEFT_DOWN, wxMouseEventHandler( WxfbFrame::onMouseDown ), NULL, this );
	trianglePanel->Connect( wxEVT_LEFT_UP, wxMouseEventHandler( WxfbFrame::onMouseUp ), NULL, this );
	trianglePanel->Connect( wxEVT_MOTION, wxMouseEventHandler( WxfbFrame::onMouseMove ), NULL, this );
	...
	frameListCtrl->Connect( wxEVT_COMMAND_DATAVIEW_ITEM_VALUE_CHANGED, wxDataViewEventHandler( WxfbFrame::onFrameValueChanged ), NULL, this );
...
WxfbFrame::~WxfbFrame()
{
	...
	trianglePanel->Disconnect( wxEVT_LEFT_DOWN, wxMouseEventHandler( WxfbFrame::onMouseDown ), NULL, this );
	trianglePanel->Disconnect( wxEVT_LEFT_UP, wxMouseEventHandler( WxfbFrame::onMouseUp ), NULL, this );
	trianglePanel->Disconnect( wxEVT_MOTION, wxMouseEventHandler( WxfbFrame::onMouseMove ), NULL, this );
	...
	frameListCtrl->Disconnect( wxEVT_COMMAND_DATAVIEW_ITEM_VALUE_CHANGED, wxDataViewEventHandler( WxfbFrame::onFrameValueChanged ), NULL, this );
